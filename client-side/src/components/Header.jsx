    ...
    <div className='flex flex-col md:flex-row flex-wrap rounded-lg px-6 md:px-10 lg:px-20 bg-primary'>
      ...
      <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
         ...
         <div className='flex flex-col md:flex-row gap-3 text-sm text-white items-center font-light '>
            ...
            <p>Simply browser through extensive list of trusted doctors, <br className='hidden sm:block' /> 
            schedule your appointment hassle-free.</p>
         </div>
         <a className='flex items-center gap-2 bg-white rounded-full text-gray-500 px-8 py-3 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300' href="#specialty">
